<header x-data="{ open: false }" class="bg-gray-100 border-b border-gray-100"
                ...
                @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                    <div class="ms-3 relative">
                        <x-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <button type="button" class="flex items-center px-3 py-2 border border-transparent text-sm font-medium text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 transition duration-150 ease-in-out">
                                    {{ Auth::user()->currentTeam->name }}
                                    <svg class="ms-2 -me-0.5 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <x-slot name="content">
                                <!-- Opciones de administración de equipo -->
                                <div class="w-60">
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 transition duration-150 ease-in-out">
                                    {{ Auth::user()->name }}
                                    <svg class="ms-2 -me-0.5 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
